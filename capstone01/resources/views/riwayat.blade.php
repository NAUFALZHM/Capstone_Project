    ...
    <main class="pt-24 px-4 flex flex-col items-center flex-grow">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-6xl">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md w-full">
                <h2 class="text-xl font-bold mb-2">Perhitungan #1</h2>
                <p><strong>Usia:</strong> 25 tahun</p>
                <p><strong>Berat Badan:</strong> 70 kg</p>
                <p><strong>Tinggi Badan:</strong> 170 cm</p>
                <p><strong>Aktivitas:</strong> Sedang</p>
                <p><strong>Kebutuhan Kalori:</strong> 2000 kcal/hari</p>
                <p><strong>IMT:</strong> 24.2</p>
                <p><strong>Status Gizi:</strong> Normal</p>
            </div>
